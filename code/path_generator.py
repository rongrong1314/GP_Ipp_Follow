...
class Path_Generator:
    ...
    def __init__(self, frontier_size, horizon_length, turning_radius, sample_step):
        '''
        frontier_size (int)：frontier上我们需要考虑的点的数量
    ...
    def generate_frontier_points(self):
        ...
        angle = np.linspace(-2.35, 2.35,
                            self.fs)  # fix the possibilities to 75% of the unit circle, ignoring points directly behind the vehicle
